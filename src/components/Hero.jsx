    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">single-tasking</span>
        </span>
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        FlowTask is like your little helper that cuts out distractions and
        busywork so you can get things done faster and more effectively to enjoy
        more freedom.
      </p>
