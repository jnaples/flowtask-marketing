    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">monk-like focus</span>
        </span>{' '}
        in your work & projects
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Say goodbye to juggling different tasks and distractions. Stay centered on what
        matters most with a tool built for single-tasking success.
      </p>
